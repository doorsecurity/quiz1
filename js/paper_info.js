...
function paperData(){
    ...
    if(sessionlist.value == "" || branchlist.value == "" || semesters.value == "" || subjects.value == "" || date.value == "" || questioncount.value == "" || marks.value == "" || duration.value == "" || passcode.value == ""){
    ...
    xmlhttp.onreadystatechange = function(){
        if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
            ...
            if(value == "1"){
                ...
                window.localtion = "../pages/homepage_faculty.php"
            }else{
...
function viewQuestion(id){
    window.open("paper_question.php?pid="+id,"_self");
}